...
self::display_output( $browser, $theme_data, $theme, $host, $WP_REMOTE_POST );
	...
	static function display_output( $browser, $theme_data, $theme, $host, $WP_REMOTE_POST ) {
		global $wpdb; ?>
// Generated by System Info Plugin //
...
if ( is_multisite() ) : ?>
	...
	//Authorize External Viewing

		//Generate External Form
		...
		//Generate External View

		//Send Hash


}
add_action( 'plugins_loaded', array( 'System_Info_Plugin', 'setup' ) );